          ...
          <div className=" flex flex-row text-white  bg-red-800 h-[60px] content-center items-center  text-center text-[25px]">
            ...
            <div className="flex flex-row justify-around items-center content-center">
              ...
              <div className=" flex flex-row justify-center w-[90%]">
                 <input type="text" id="success" className="w-[95%] bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block  p-2.5 dark:bg-gray-700 dark:border-green-500" placeholder="title ... " />
              </div>
              </div>
              ...
              <div className=" flex flex-row justify-arround w-[70%] "> 
                <input type="text" id="success" className="w-[95%] bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block  p-2.5 dark:bg-gray-700 dark:border-green-500" placeholder="price ... " />
              </div>
